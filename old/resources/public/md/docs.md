<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Add the connection parameters in the <code>mergecake.models.db</code> namespace.
...
Two middleware functions by default which are are located in the `mergecake.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `mergecake.handler` namespace to manage the enabled middleware.
